//
//	位置とテクスチャ座標、法線、カラー情報をもつメッシュの描画パイプライン
//
#ifndef _HINODE_GRAPHICS_PTNC_VERTEX_PIPELINE_
#define _HINODE_GRAPHICS_PTNC_VERTEX_PIPELINE_
...
{
	float4 albedo = txTexture.Sample(smSampler, input.texcoord) * input.color;
